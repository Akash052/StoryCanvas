...
import com.example.mystorycanvas.detectors.MoveGestureDetector;
import com.example.mystorycanvas.detectors.RotateGestureDetector;
...
public class MotionView extends FrameLayout {
    ...
    public MotionView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
